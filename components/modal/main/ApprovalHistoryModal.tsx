  ...
  return (
    <>
      <div
        className={
          isModalOpen
            ? `${style.modalWrap} ${style.modalOpen} `
            : `${style.modalWrap}`
        }
      >
        <div
          className={style.modalHeaderWrap}
        ...
        >
          ...
          <div className={style.modalHeaderSubject}>
            ...
            {isModalOpen ? (
              <p className={style.HistoryLink}>all history</p>
            ) : (
              ""
            )}
          </div>
        </div>
        <div className={style.modalContentsWrap}>{/* <Approval /> */}</div>
      </div>
      <div
        className={
          isModalOpen ? style.modalBackground : style.modalBackgroundClose
        }
        onClick={() => setIsModalOpen(!isModalOpen)}
      ></div>
    </>
