                    ...
                    <>
                        <div className={style.ReceiptOCRWrap}>
                            <div className={style.ReceiptOCRHeader}>
                                <Text h4 css={{ color: 'var(--bibot-primary' }}>Payment Details</Text>
                            </div>
                            <Table
                                aria-label='영수증 정보'
                            ...
                            >
                                <Table.Header columns={columns}>
                                    {(column) => (
                                        <Table.Column align='center' key={column.key} css={{ backgroundColor: 'var(--bibot-primary' }}>{column.label}</Table.Column>
                                    )}
                                </Table.Header>
